...
setwd("D:/Forest_loss/Caravan/timeseries/netcdf/camelscl")

gage_loss_yrs=read.csv("D:/Forest_loss/Caravan/camels_chile_loss_yr.csv")
gage_loss_yrs[c("camels", "num")] = do.call(rbind, strsplit(gage_loss_yrs$gauge_id, "_"))

for (k in 1:302)
{
  nc_data = nc_open(paste("camelscl_",gage_loss_yrs$num[k],".nc",sep=""))
...
write.csv(gage_loss_yrs,"D:/Forest_loss/Catchment_stats/5yr/ForestLoss_CatchmentStats_CL_5yr.csv")
