...
setwd("D:/Forest_loss/Caravan/timeseries/netcdf/hysets")

gage_loss_yrs=read.csv("D:/Forest_loss/Caravan/camels_hysets_loss_yr1.csv")
...
k=4436
  ...
  nc_data = nc_open(paste("hysets_",gage_loss_yrs$num[k],".nc",sep=""))
...
#}
  ...
  write.csv(gage_loss_yrs,"D:/Forest_loss/Catchment_stats/5yr/ForestLoss_CatchmentStats_HYSETS_5yr.csv")
