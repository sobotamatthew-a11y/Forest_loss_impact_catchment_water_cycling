...
%% Directory & Load Data
basePath = 'D:\Forest_loss\HPC\Plots\before_vs_after\041426\';
...
%% Shared X labels
axTop = nexttile(2);
xlabel(axTop, 'EI Before', 'FontName','Times New Roman','FontSize',15);

axBottom = nexttile(5);
xlabel(axBottom, 'RB Before', 'FontName','Times New Roman','FontSize',15);
