...
# 3. Load data 
data_path <- "D:/Forest_loss/HPC/030926_result/datasets/data_rb5.csv"
...
rf_grid <- h2o.grid(
  ...
  hyper_params    = list(
    ...
    mtries      = c(1,2)  # c(2,4,6,8) when predictors > 2 c(1,2) when predictors = 2
  ),
...
custom_labels <- c(
 "annual discharge volume",
  "catchment area",
  "gross domestic product (spatial sum)",
  "latitude",
